...
public class DashboardView extends View {
    ...
    public DashboardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRadius = a.getDimensionPixelSize(R.styleable.DashboardView_radius, dpToPx(70));
    ...
    private void playAnimation(float targetValue) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
            	String animationStr = animation.getAnimatedValue()+"";
//            	Log.i("info", "animation.getAnimatedValue() = "+animation.getAnimatedValue());
                mRealTimeValue = (float) Math.ceil(Double.valueOf(animationStr));
